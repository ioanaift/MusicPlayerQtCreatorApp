...
void MainWindow::on_actionShuffle_toggled(bool checked)
{
    if(checked){
   ...
   if(!checked){
        ...
        ui->statusBar->showMessage("Unshuffled");
   }
}
void MainWindow::on_actionRepeat_toggled(bool checked)
{
    if(checked){
        playlist->setPlaybackMode(QMediaPlaylist::CurrentItemInLoop);
        ui->statusBar->showMessage("Current Item on Repeat");
    }
   if(!checked){
        playlist->setPlaybackMode((QMediaPlaylist::Sequential));
        }
